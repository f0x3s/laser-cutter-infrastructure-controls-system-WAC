...
> * [arduino-industrial-AHU-interface-WAC](https://github.com/f0x3s/arduino-industrial-AHU-interface-WAC) — *Interface beween control module and __Paint Booth AHU__ 3-phase motor controller*
...
* While not explicitly shown in this diagram, during operation of either the **Laser** or **Fume Hood** the switch in the **Paint Booth** is interrupted at the **Paint Booth AHU** motor controller in the **Fan Room** so that it may not be used to turn off **Paint Booth AHU**. See: ['arduino-industrial-AHU-interface-WAC'](https://github.com/f0x3s/arduino-industrial-AHU-interface-WAC)
